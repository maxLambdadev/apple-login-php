...
header("Location: https://appleid.apple.com/auth/authorize?client_id={$client_id}&redirect_uri={$redirect_uri}&response_type=code&scope=email%20name&response_mode=form_post");
